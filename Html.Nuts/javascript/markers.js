define([
	...
	function addMarker(parent, markerType, opt_classArray, opt_additionalConfig) {
		if (opt_classArray !== null) {
			console.assert(Array.isArray(opt_classArray), "opt_classArray must be an array")
		}
		...
		var height = additionalConfig.height ? additionalConfig.height: gameUtils.elementHeight - shrinkage
		var width = additionalConfig.width ? additionalConfig.width: gameUtils.elementWidth - shrinkage
